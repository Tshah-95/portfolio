  ...
  return (
    <main className="flex min-h-screen bg-navy-950 flex-col items-center justify-between p-6 md:p-24 relative">
      <div className="max-w-screen-lg">
        <div className="relative flex flex-col w-full py-10 md:py-16 px-5 md:px-10 max-h-[400px] gap-3 md:gap-10 mt-24">
          ...
          <div>
            ...
            <h1 className="flex items-center gap-2 md:gap-3 text-3xl md:text-6xl text-slate-400 font-bold ">
              that are
              <motion.span
                className="text-left bg-gradient-to-br text-transparent py-1 md:py-2 bg-clip-text from-navy-400 via-navy-300 to-navy-400"
                style={{ translateX: promptX, opacity }}
              >
                {descriptors[currDescriptor]}
              </motion.span>
            </h1>
            <Balancer className="text-sm md:text-lg font-medium text-slate-500 mt-4 md:mt-12 max-w-[40em]">
